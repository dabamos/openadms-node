...
class ErrorGenerator(Prototype):
    ...
    def __init__(self, module_name: str, module_type: str, manager: Manager):
        ...
        self._is_warning_enabled = config.get('warning')
        self._is_error_enabled = config.get('error')
        self._is_critical_enabled = config.get('critical')
    ...
    def run(self) -> None:
        while self.is_running:
            ...
            if self._is_critical_enabled:
                self.logger.critical('<<< CRITICAL log message #{} >>>'
